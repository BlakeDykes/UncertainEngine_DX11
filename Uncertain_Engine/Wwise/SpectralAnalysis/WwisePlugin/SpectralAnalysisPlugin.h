...
class SpectralAnalysisPlugin final
...
DECLARE_AUDIOPLUGIN_CONTAINER(SpectralAnalysis);	// Exposes our PluginContainer structure that contains the info for our plugin
