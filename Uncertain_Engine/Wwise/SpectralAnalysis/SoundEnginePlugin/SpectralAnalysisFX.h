...
#ifndef SpectralAnalysisFX_H
#define SpectralAnalysisFX_H
#include "_def_SA.h"
...
class SpectralAnalysisFX
    : public AK::IAkInPlaceEffectPlugin
{
public:
    SpectralAnalysisFX();
    ~SpectralAnalysisFX() = default;
...
private:
    SpectralAnalysisFXParams* m_pParams;
    AK::IAkPluginMemAlloc* m_pAllocator;
    AK::IAkEffectPluginContext* m_pContext;
    
    FFT* poFFT;
    DAOManager* poDAOManager;
};

#endif // SpectralAnalysisFX_H
