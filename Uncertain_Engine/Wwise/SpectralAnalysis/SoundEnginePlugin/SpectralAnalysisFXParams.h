...
#ifndef SpectralAnalysisFXParams_H
#define SpectralAnalysisFXParams_H
...
static const AkPluginParamID PARAM_OBJECT_ID = 0;
static const AkUInt32 NUM_PARAMS = 1;

struct SpectralAnalysisRTPCParams
{
};

struct SpectralAnalysisNonRTPCParams
{
    AkUInt32 ObjectID;
};

struct SpectralAnalysisFXParams
    : public AK::IAkPluginParam
{
    SpectralAnalysisFXParams();
    SpectralAnalysisFXParams(const SpectralAnalysisFXParams& in_rParams);

    ~SpectralAnalysisFXParams() = default;
    ...
    SpectralAnalysisRTPCParams RTPC;
    SpectralAnalysisNonRTPCParams NonRTPC;
};
