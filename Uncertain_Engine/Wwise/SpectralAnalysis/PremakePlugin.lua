...
local Plugin = {}
Plugin.name = "SpectralAnalysis"
Plugin.factoryheader = "../SoundEnginePlugin/SpectralAnalysisFXFactory.h"
Plugin.appleteamid = ""
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "SpectralAnalysis.def",
    "SpectralAnalysis.xml",
    "**.rc",
}
