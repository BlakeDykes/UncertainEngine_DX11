...
#ifndef SpectralAnalysisConfig_H
#define SpectralAnalysisConfig_H
...
namespace SpectralAnalysisConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 10594;
}

#endif // SpectralAnalysisConfig_H
