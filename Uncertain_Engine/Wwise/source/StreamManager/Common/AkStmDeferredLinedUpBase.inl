	...
	)
{
	...
	else
	{
		...
		bool hasPendingIO = !m_listPendingXfers.IsEmpty() || !m_listCancelledXfers.IsEmpty();
		TStmBase::UpdateTaskStatus( in_eIOResult, hasPendingIO );
	...
	)
{
...

	{
		...
		while ( it != m_listCancelledXfers.End() )
		{
			...
			pTransfer->Cancel( 
				TStmBase::m_pDevice->GetLowLevelHook(),
				bCallLowLevelIO, 
